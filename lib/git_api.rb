...
#      def set_git_bin_path=(path)
#        @git_bin_path = path
#      end
#
#      def get_git_bin_path
#        @git_bin_path
#      end
#
...
#Gitlog::Base::Config.set_git_repositories_root = "~/repositories"
...
module Gitlog
  module Base
    ...
    Action.class_eval do
      extend Gitlog::Base::Command
      extend Gitlog::Base::Config
    end
#    Action.send :extend, Gitlog::Base::Command
#    Action.send :include, Gitlog::Base::Config
  end
end

class Action < Gitlog::Base::Action
